...
export default function Home() {
  ...
  useEffect(() => {
    ...
    async function getAccessToken() {
      try {
        const res = await axios.get(`http://localhost:8000/auth/google/callback?code=${code}`);
        console.log(res);
      } catch (error) {
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-16">
          <div className="text-center flex  flex-col items-center gap-8">
            <h1 className="text-6xl font-bold font-sans">Redefining the way you refer your knowledge source.</h1>
            <div className="max-w-2xl bg-Sec-Amber py-3 -rotate-3">
              {" "}
              <h1 className="text-4xl font-bold rotate-3  text-white sm:text-6xl font-sans transform ">Making it easy to navigate your knowlegebase</h1>
            </div>

            <p className="max-w-xl mt-6 text-medium leading-8 text-gray-600">
              Out main objective is to make you 10x more productive. We are here to help you to find the information you need in a within a few seconds.
            </p>
